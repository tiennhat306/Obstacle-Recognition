  ...
  Future<void> sendNotification(
    ...
    await http.post(uri,
        headers: <String, String>{
          ...
          'Authorization':
              'key=AAAAN2mujTY:APA91bGzEWu4JfM-QCN73d-nBsTL6axccuSvtDZdk3sBbAo2MZBTbpBwJB7EZlH5ceszbRVAQ6C-kt0UEWY0e6qBEhbwI7wFaofPwJoaVqiq29_oD25VngkcRmrTTWJwwYVa5LHmKF_s'
        },
