      ...
      children: [
            ...
            child: Row(
              children: [
                CircleAvatar(
                  ...
                  child: IconButton(
                    icon: const Icon(Icons.arrow_back_ios_new_rounded, size: 20, color: ColorsEnum.primaryColor ),
                ...
                Container(
                  ...
                  child: BlocBuilder<MylocationmapBloc, MylocationmapState>(
                    builder: (_, state) 
                      => TextCustom(text: state.street, color: ColorsEnum.primaryColor, fontSize: 17, maxLine: 3, )
                  ),
                )
              ],
            ),
        ...
        Positioned(
          ...
          child: MaterialButton(
            ...
            child: const TextCustom(text: 'Xác nhận địa chỉ', color: Colors.white, fontSize: 17,),
            onPressed: (){
              if( myLocationBloc.state.reference != '' ){
