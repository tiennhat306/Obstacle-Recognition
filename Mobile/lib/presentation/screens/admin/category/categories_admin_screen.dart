...
import 'package:vision_aid/presentation/screens/admin/category/add_category_admin_screen.dart';
...
class _ListCategories extends StatelessWidget {
  ...
  final List<Device> listCategory;
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: ColorsEnum.primaryColor, width: 4.5)
                  ),
                ),
                const SizedBox(width: 20.0),
                TextCustom(text: listCategory[i].username),
              ],
            ),
          ),
        ),
