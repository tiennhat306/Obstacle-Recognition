...
// import 'package:vision_aid/domain/models/pay_type.dart';
...
// import 'package:vision_aid/presentation/screens/admin/orders_admin/order_details_screen.dart';
...
//               children: const [
//                 Icon(Icons.arrow_back_ios_new_outlined, color: ColorsEnum.primaryColor, size: 17),
...
//           bottom: TabBar(
//             indicatorWeight: 2,
//             labelColor: ColorsEnum.primaryColor,
...
//                 children: [
//                   const TextCustom(text: 'Date', fontSize: 16, color: ColorsEnum.secundaryColor),
...
//                 mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                 children: [
//                   const TextCustom(text: 'Client', fontSize:16, color: ColorsEnum.secundaryColor),
//                   TextCustom(text: orderResponse.cliente, fontSize: 16),
//                 ],
//               ),
//               const SizedBox(height: 10.0),
//               const TextCustom(text: 'Address shipping', fontSize: 16, color: ColorsEnum.secundaryColor),
