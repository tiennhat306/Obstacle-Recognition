...
// import 'package:vision_aid/domain/models/response/orders_by_status_response.dart';
...
// import 'package:vision_aid/presentation/screens/admin/orders_admin/orders_admin_screen.dart';
...
//               children: const [
//                 Icon(Icons.arrow_back_ios_new_rounded, size: 17, color: ColorsEnum.primaryColor ),
//                 TextCustom(text: 'Back', color: ColorsEnum.primaryColor, fontSize: 17)
//               ],
//             ),
//           ),
//         ),
...
//                       children: [
//                         const TextCustom(text: 'Total', color: ColorsEnum.secundaryColor, fontSize: 22, fontWeight: FontWeight.w500),
...
//                       mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                       children: [
//                         const TextCustom(text: 'Cliente:', color: ColorsEnum.secundaryColor, fontSize: 16),
...
//                       mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                       children: [
//                         const TextCustom(text: 'Date:', color: ColorsEnum.secundaryColor, fontSize: 16),
//                         TextCustom(text: DateCustom.getDateOrder(order.currentDate.toString()), fontSize: 16),
//                       ],
//                     ),
//                     const SizedBox(height: 10.0),
//                     const TextCustom(text: 'Address shipping:', color: ColorsEnum.secundaryColor, fontSize: 16),
...
//                       mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                       children: [
//                         const TextCustom(text: 'Delivery', fontSize: 17, color: ColorsEnum.secundaryColor),
//                         Row(
//                           children: [
//                             Container(
//                               height: 40,
