...
import 'package:vision_aid/presentation/screens/admin/admin_home_screen.dart';
          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const [
                  TextCustom(text: 'Frave ', fontSize: 25, color: ColorsEnum.primaryColor, fontWeight: FontWeight.w500 ),
                  TextCustom(text: 'Food', fontSize: 25, color: ColorsEnum.secundaryColor, fontWeight: FontWeight.w500 ),
                ],
              ),
              const SizedBox(height: 20.0),
              const TextCustom(text: 'How do you want to continue?', color: ColorsEnum.secundaryColor, fontSize: 25,),
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                TextCustom(text: text, fontSize: 20, color: ColorsEnum.secundaryColor )
              ],
            ),
          ),
        ),
