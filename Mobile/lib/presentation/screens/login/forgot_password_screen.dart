...
import 'package:vision_aid/presentation/components/form_field_valid.dart';
import 'package:vision_aid/presentation/helpers/helpers.dart';
import 'package:vision_aid/presentation/screens/login/check_email_screen.dart';
          ...
          child: Row(
            ...
            children: const [
              Icon(Icons.arrow_back_ios_new_rounded,
                  size: 18, color: ColorsEnum.primaryColor),
              TextCustom(
                  text: 'Back', color: ColorsEnum.primaryColor, fontSize: 16)
            ],
          ),
        ),
        actions: const [
          ...
          child: ListView(
            ...
            children: [
              ...
              Btn(
                ...
                onPressed: () {
                  Navigator.push(
                      context, routeCustom(page: CheckEmailScreen()));
                },
              )
            ],
          ),
