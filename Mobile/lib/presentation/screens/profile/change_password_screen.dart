      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            ...
            leading: TextButton(
              ...
              child: const TextCustom(text: 'Cancel', fontSize: 17, color: ColorsEnum.primaryColor )
            ),
            actions: [
              TextButton(
                onPressed: (){
                ...
                child: const TextCustom(text: 'Save', fontSize: 16, color: ColorsEnum.primaryColor)
              )
            ],
          ),
        body: SafeArea(
