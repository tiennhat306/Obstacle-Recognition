            ...
            TextButton(
              onPressed: (){
                if( _keyForm.currentState!.validate()){
                  userBloc.add( OnEditUserEvent( _nameController.text, _phoneController.text, _emailController.text ));
                }
              }, 
          ...
          child: Form(
            ...
            padding: const EdgeInsets.symmetric(horizontal: 20.0, vertical: 10.0),
              children: [
                ...
                const SizedBox(height: 20.0),
                const TextCustom(text: 'Email Address', color: ColorsEnum.secundaryColor),
                const SizedBox(height: 5.0),
                FormFieldFrave(
