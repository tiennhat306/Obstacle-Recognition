...
//         // Navigator.pushReplacement(context, routeFrave(page: MapScreen(order: widget.order)));
//         break;
...
//                     size: 17, color: ColorsEnum.primaryColor),
//                 TextCustom(
//                     text: 'Back', color: ColorsEnum.primaryColor, fontSize: 17)
//               ],
//             ),
//           ),
//         ),
...
//                                 // Navigator.push(context, routeFrave(page: MapScreen(order: widget.order)));
//                               }
//                             },
//                           ),
//                         )
