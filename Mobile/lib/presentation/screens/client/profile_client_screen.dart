...
import 'package:vision_aid/presentation/screens/client/client_orders_screen.dart';
          ...
          child: ListView(
            ...
            children: [
              ...
              ItemAccount(
                ...
                onPressed: () => Navigator.push(context, routeFrave(page: EditDeviceNetworkScreen())),
              ),
              ItemAccount(
                text: 'Add devices',
                icon: Icons.add_to_home_screen_rounded,
                colorIcon: 0xff051E2F,
                onPressed: () => Navigator.push(context, routeFrave(page: AddDeviceScreen())),
              ),
              const SizedBox(height: 15.0),
