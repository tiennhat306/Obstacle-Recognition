...
// import 'package:vision_aid/presentation/screens/client/check_out_screen.dart';
...
//           icon: Row(
//             children: const [
//               Icon(Icons.arrow_back_ios_new_rounded, color: ColorsEnum.primaryColor, size: 19),
...
//                                           TextCustom(text: '\$ ${state.products![i].price * state.products![i].quantity}', color: ColorsEnum.primaryColor )
//                                         ],
//                                       ),
//                                     ),
//                                     Expanded(
...
//                                             ),
//                                             const SizedBox(width: 10.0),
//                                             TextCustom(text: '${state.products![i].quantity}', color: ColorsEnum.primaryColor ),
//                                             const SizedBox(width: 10.0),
//                                             Container(
//                                               alignment: Alignment.center,
//                                               padding: const EdgeInsets.all(2.0),
...
//                         color: (state.quantityCart != 0) ? ColorsEnum.primaryColor : ColorsEnum.secundaryColor,
//                         onPressed: (){
...
//         const TextCustom(text: 'Without products', fontSize: 21, fontWeight: FontWeight.w500, color: ColorsEnum.primaryColor,)
//       ],
//     );
//   }
// }