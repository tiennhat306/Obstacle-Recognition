...
import 'package:vision_aid/presentation/screens/client/client_details_order_screen.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          TextCustom(text: 'ORDER # ${listOrders[i].id}', fontSize: 16, fontWeight: FontWeight.w500, color: ColorsEnum.primaryColor),
                          TextCustom(text: listOrders[i].status ,
                            fontSize: 16, 
                            fontWeight: FontWeight.w500, 
                            color: ( listOrders[i].status == 'DELIVERED' ? ColorsEnum.primaryColor : ColorsEnum.secundaryColor )
                          ),
                        ],
                      ),
                      const Divider(),
