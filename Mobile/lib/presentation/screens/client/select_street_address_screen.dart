...
class SelectStreetAddressScreen extends StatefulWidget {
  @override
  _SelectStreetAddressScreenState createState() =>
      _SelectStreetAddressScreenState();
}
    ...
    return BlocListener<UserBloc, UserState>(
      listener: (context, state) {
        if (state is LoadingUserState) {
          ...
          modalSuccess(
              context,
              'Select Address added successfully',
        ...
        appBar: AppBar(
          ...
          actions: [
            TextButton(
                ...
                child: const TextCustom(
                    text: 'OK', color: ColorsEnum.primaryColor, fontSize: 17)),
          ],
        ),
        body: SafeArea(
          child: Form(
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: BlocBuilder<MylocationmapBloc, MylocationmapState>(
                          builder: (_, state) =>
                              TextCustom(text: state.existsLocation ? 'Đã xác định vị trí': 'Vị trí không xác định')),
                    ),
                  ),
                  SizedBox(height: 5.0),
                  Align(
