...
import 'package:vision_aid/domain/models/response/products_top_home_response.dart';
...
import 'package:vision_aid/presentation/screens/client/cart_client_screen.dart';
import 'package:vision_aid/presentation/screens/client/client_map_screen.dart';
import 'package:vision_aid/presentation/screens/client/details_product_screen.dart';
import 'package:vision_aid/presentation/screens/client/search_for_category_screen.dart';
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => MapScreen(deviceId: device[i].id, sourceLocation: authBloc.state.user!.address!,)),
                                    );
                                  },
                                  child: Container(
                                    height: 60,
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    TextCustom(text: device[i].username ?? 'Vị Trí Người Thân'),
                                    InkWell(
                                      // onTap: () => Navigator.push(
                                      //     context, routeFrave(page: ListAddressesScreen())),
                                      onTap: ()=>(),
                                      child: TextCustom(
                                            text: device[i].street ?? 'Xác định vị trí',
                                            color: ColorsEnum.primaryColor,
                                            fontSize: 17,
                                            maxLine: 1,
                                          ),
