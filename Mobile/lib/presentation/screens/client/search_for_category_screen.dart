...
import 'package:vision_aid/presentation/components/StaggeredDualView.dart';
              ...
              child: GestureDetector(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextCustom(text: listProduct[i].nameProduct , textOverflow: TextOverflow.ellipsis, fontWeight: FontWeight.w500, color: ColorsEnum.primaryColor, fontSize: 19 ),
  ...
  Widget _withoutProducts(){
    return Column(
      children: [
        ...
        const TextCustom(text: 'Without products', fontSize: 21, color: ColorsEnum.primaryColor )
      ],
    );
  }
