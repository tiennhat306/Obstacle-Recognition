...
import 'package:vision_aid/domain/models/response/order_details_response.dart';
import 'package:vision_aid/domain/models/response/orders_client_response.dart';
...
import 'package:vision_aid/presentation/screens/client/client_map_screen.dart';
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          child: Row(
            ...
            children: const [
              Icon(Icons.arrow_back_ios_new_rounded, color: ColorsEnum.primaryColor, size: 17),
              TextCustom(text: 'Back', fontSize: 17, color: ColorsEnum.primaryColor )
            ],
          ),
        ),
        actions: [
          Container(
            ...
            child: TextCustom(
              ...
              color: (orderClient.status == 'DELIVERED' ? ColorsEnum.primaryColor : ColorsEnum.secundaryColor),
            ),
          ),
        ],
      ),
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const TextCustom(text: 'TOTAL', fontWeight: FontWeight.w500, color: ColorsEnum.primaryColor ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const TextCustom(text: 'DELIVERY', fontWeight: FontWeight.w500, color: ColorsEnum.primaryColor, fontSize: 17),
                    Row(
                      children: [
                        Container(
                          height: 35,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const TextCustom(text: 'DATE', fontWeight: FontWeight.w500, color: ColorsEnum.primaryColor , fontSize: 17),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const TextCustom(text: 'ADDRESS', fontWeight: FontWeight.w500, color: ColorsEnum.primaryColor , fontSize: 16),
