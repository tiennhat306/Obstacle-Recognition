...
import 'package:vision_aid/presentation/screens/login/register_client_screen.dart';
        ...
        title: Row(
          ...
          children: const [
            TextCustom(
                ...
                fontSize: 25),
            TextCustom(text: 'Aid', fontSize: 25, fontWeight: FontWeight.w500),
          ],
        ),
        backgroundColor: Colors.white,
        elevation: 0,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 350,
              width: size.width,
              child: Image.asset('Assets/Logo/logo-black.png', height: 150),
            ),
            Column(
              children: [
                _BtnSocial(
                ...
                _BtnSocial(
                  ...
                  onPressed: () => Navigator.push(
                      context, routeCustom(page: RegisterClientScreen())),
                ),
