          ...
          children: [
            ...
            Expanded(
              ...
              builder: (_, snapshot) {
                ...
                final List<Device>? category = snapshot.data;
                    ...
                    : Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, i) 
                          => InkWell(
                            // onTap: () => productBloc.add(OnSelectCategoryEvent(category[i].id, category[i].username)),
                            child: Container(
                                height: 40,
                                color: Colors.white,
                                child: Row(
                                    ...
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          width: 20,
                                          decoration: BoxDecoration(
                                            border: Border.all(color: ColorsEnum.primaryColor, width: 3.5),
                                            borderRadius: BorderRadius.circular(6.0)
                                          ),
                                        ),
                                        const SizedBox(width: 10.0),
                                        TextCustom(text: category![i].username)
                                      ],
                                    ),
